...
void Archivostxt::leerDesdeArchivo(string nombreArchivo, ArbolParqueadero &arbol) {
...
void Archivostxt::guardarEnArchivo(string nombreArchivo, ArbolParqueadero &arbol) {
...
arbol.recorrerPreOrden([&archivo](NodoVehiculo* vehiculo) {
